...
for benchmark in CP LIB LPS NQU RAY STO
do
              mkdir $benchmark
              cd $benchmark
              ln -s /home/cy0194/cpugpusim1/benchmarks/CUDA/$benchmark/gpgpu_ptx_sim__$benchmark .
              cp /home/cy0194/cpugpusim1/bash-scripts/run_scripts/CUDA/mainscript_$benchmark .
              chmod 777 mainscript_$benchmark
              cd ../
done

#for benchmark in AES BFS MUM NN kmeans WP JPEG 
for benchmark in AES BFS MUM NN WP
do
              mkdir $benchmark
              cd $benchmark
              ln -s /home/cy0194/cpugpusim1/benchmarks/CUDA/$benchmark/gpgpu_ptx_sim__$benchmark .
              ln -s /home/cy0194/cpugpusim1/benchmarks/CUDA/$benchmark/data . 
              cp /home/cy0194/cpugpusim1/bash-scripts/run_scripts/CUDA/mainscript_$benchmark .
              chmod 777 mainscript_$benchmark
              cd ../
done
