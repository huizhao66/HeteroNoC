...
do
              mkdir $benchmark
              cd $benchmark
              ln -s /home/cy0194/cpugpusim1/benchmarks/rodinia/cuda/$benchmark/gpgpu_ptx_sim__$benchmark .
              cp /home/cy0194/cpugpusim1/bash-scripts/run_scripts/rodinia/mainscript_$benchmark .
...
do
			 mkdir $benchmark
			 cd $benchmark
			 ln -s /home/cy0194/cpugpusim1/benchmarks/rodinia/cuda/$benchmark/cuda/gpgpu_ptx_sim__$benchmark .
             cp /home/cy0194/cpugpusim1/bash-scripts/run_scripts/rodinia/mainscript_$benchmark .
             chmod 777 mainscript_$benchmark
             cd ../
done
...
do
			 mkdir $benchmark
			 cd $benchmark
			 ln -s /home/cy0194/cpugpusim1/benchmarks/rodinia/cuda/srad/$benchmark/gpgpu_ptx_sim__srad .
             cp /home/cy0194/cpugpusim1/bash-scripts/run_scripts/rodinia/mainscript_$benchmark .
             chmod 777 mainscript_$benchmark
             cd ../
done
...
do
			 mkdir $benchmark
			 cd $benchmark
			 ln -s /home/cy0194/cpugpusim1/benchmarks/rodinia/cuda/particlefilter/gpgpu_ptx_sim__particlefilter_float .
             cp /home/cy0194/cpugpusim1/bash-scripts/run_scripts/rodinia/mainscript_$benchmark .
             chmod 777 mainscript_$benchmark
             cd ../
done
...
do
			 mkdir $benchmark
			 cd $benchmark
			 ln -s /home/cy0194/cpugpusim1/benchmarks/rodinia/cuda/particlefilter/gpgpu_ptx_sim__particlefilter_naive .
             cp /home/cy0194/cpugpusim1/bash-scripts/run_scripts/rodinia/mainscript_$benchmark .
             chmod 777 mainscript_$benchmark
             cd ../
done
...
ln -s /home/cy0194/cpugpusim1/benchmarks/rodinia/data . 
cd ../
