...
do
              mkdir $benchmark
              cd $benchmark
              ln -s /home/cy0194/cpugpusim1/benchmarks/Mars/sample_apps/$benchmark/gpgpu_ptx_sim__$benchmark .
              cp /home/cy0194/cpugpusim1/bash-scripts/run_scripts/mars/mainscript_$benchmark .
...
do
              ...
              cd $benchmark
              ln -s /home/cy0194/cpugpusim1/benchmarks/Mars/sample_apps/$benchmark/gpgpu_ptx_sim__$benchmark .
              ln -s /home/cy0194/cpugpusim1/benchmarks/Mars/sample_apps/$benchmark/data . 
              cp /home/cy0194/cpugpusim1/bash-scripts/run_scripts/mars/mainscript_$benchmark .
              chmod 777 mainscript_$benchmark
              cd ../
done
